...
kk = LineAlpha.LINE()
kk.login(token="EkldgGhR3RTsoIlklvs5.Zt4YIFAhJQ/aODsJI1I0jq.AjiLH+xhtyaPOSos5FuAKg7nnu2Pb3/RC/OSEKv1DXI=")
kk.loginResult()
...
kj = LineAlpha.LINE()
kj.login(token="EkCEOVnroPR5Zh1G97Ge.YTDwI5QhiUpG18DJ9xbkNG.vO7dkmpu0Jffv3Q7S3dJNd04vr7mm5ABIckBlpsvxnk=")
kj.loginResult()
...
def bot(op):
        ...
        if op.type == 13:
                ...
                if op.param3 in Amid:
                    if op.param2 in Bmid:
                        ...
                        kj.accepfGroupInvitationByTicket(op.param1,Ti)
			...
			kd.accepfGroupInvitationByTicket(op.param1,Ti)
                        X.preventJoinByTicket = True
                        ke.updateGroup(X)
                        Ti = ke.reissueGroupTicket(op.param1)
			...
			ke.accepfGroupInvitationByTicket(op.param1,Ti)
                        X.preventJoinByTicket = True
                        kf.updateGroup(X)
                        Ti = kf.reissueGroupTicket(op.param1)
			...
			kg.accepfGroupInvitationByTicket(op.param1,Ti)
                        X.preventJoinByTicket = True
                        kh.updateGroup(X)
                        Ti = kh.reissueGroupTicket(op.param1)
			...
			kh.accepfGroupInvitationByTicket(op.param1,Ti)
                        X.preventJoinByTicket = True
                        kj.updateGroup(X)
                        Ti = kj.reissueGroupTicket(op.param1)
	...
	if op.type == 11:
        ...
        if op.type == 26:
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                ...
                cl.sendMessage(msg)
	    elif msg.text in ["protect on","protect:on","Protect on","Protect:on"]:
	       if msg.from_ in admin:
		if wait["protect"] == True:
			...
			cl.sendText(msg.to,"Done")
	    elif msg.text in ["protect off","Protect off","Protect:off","protect:off"]:
	       if msg.from_ in admin:
		if wait["protect"] == False:
			...
			cl.sendText(msg.to,"Done")
	    elif msg.text in ["protectinv on","protectinv:on","Protectinv:on","Protectinv on"]:
	       if msg.from_ in admin:
		if wait["protectinv"] == True:
			...
			cl.sendText(msg.to,"Done")
	    elif msg.text in ["protectinv off","Protectinv off","Protectinv:off","protectinv:off","deff off"]:
	       if msg.from_ in admin:
		if wait["protectinv"] == False:
			...
			cl.sendText(msg.to,"Done")
	    elif msg.text in ["protectqr on","protectqr:on","Protectqr:on","Protectqr on","deff on"]:
	       if msg.from_ in admin:
		if wait["protectqr"] == True:
			...
			cl.sendText(msg.to,"Done")
	    elif msg.text in ["protectqr off","Protectqr:off","Protectqr off","protectqr:off"]:
	       if msg.from_ in admin:
...
#-----------------------------------------------
            ...
            elif msg.text in ["All join","sini masuk","kuy sini","sokin","all join"]:
		if msg.from_ in admin:
...
#.acceptGroupInvitationByTicket(msg.to,Ticket)
                        ...
                        kc.updateGroup(G)
#-----------------------------------------------
            elif msg.text in ["Bye all","dadah","bye all","out"]:
                if msg.from_ in admin:
                    ginfo = cl.getGroup(msg.to)
                    try:
			...
			kj.leaveGroup(msg.to)
                ...
                if msg.toType == 2:
                    ...
                    try:
                        ...
                        pass
	    elif msg.text in ["bot1 @bye","Bot1 @bye"]:
		if msg.from_ in admin:
		    ginfo = cl.getGroup(msg.to)
		    try:
...
#-----------------------------------------------
                ...
                if msg.from_ in admin:
                    ki.sendText(msg.to,"Ready 􀨁􀄻double thumbs up􏿿")
                    kk.sendText(msg.to,"Ready 􀨁􀄻double thumbs up􏿿")
                    kc.sendText(msg.to,"Ready 􀨁􀄻double thumbs up􏿿")
#-----------------------------------------------
            elif "Bc " in msg.text:
...
#-----------------------------------------------
            ...
            elif msg.text in ["Bot say didik pekok"]:
            ...
            elif msg.text in ["Bot say bobo ah","Bobo dulu ah"]:
            ...
            elif msg.text in ["Bot say chomel pekok"]:
...
#-----------------------------------------------
            elif msg.text in ["absen","Absen","1-10"]:
	       if msg.from_ in admin:
