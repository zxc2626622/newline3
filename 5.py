             ...
             if msg.from_ in admin:
                if wait["autoJoin"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"done")
            elif msg.text in ["è‡ªå‹•å‚åŠ :ã‚ªãƒ•","Join off","Auto join:off"]:
             if msg.from_ in admin:
...
#-----------------------------------------------
            ...
            elif msg.text in ["woi masuk","sini masuk","kuy sini","sokin","Sokin"]:
...
#-----------------------------------------------
                ...
                if msg.from_ in admin:
                    print "ok"
                    _name = msg.text.replace("rata","Rata")
...
#------------------------------------------------------------------
		...
		kl.sendText(msg.to,"send contact")
			...
			kf.sendText(msg.to,"There was no blacklist user")
