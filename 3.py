...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Lmid]
	...
	if op.type == 11:
        ...
        if op.type == 26:
			...
			kl.sendText(msg.to,"It is not in the black list")
                ...
                cl.kickoutFromGroup(msg.to,[midd],admin)
                ...
                if msg.from_ in admin:
                    ...
                    if G.invitee is not None:
                        ...
                        kl.cancelGroupInvitation(msg.to, gInviMids)
                    else:
                        if wait["lang"] == "JP":
                            kl.sendText(msg.to,"No one is inviting")
                        else:
                            kl.sendText(msg.to,"Sorry, nobody absent")
                else:
                    if wait["lang"] == "JP":
                        kl.sendText(msg.to,"Can not be used outside the group")
                    else:
                        kl.sendText(msg.to,"Not for use less than group")
            #elif "gurl" == msg.text:
                ...
                if msg.from_ in admin:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Cv1 ourl","Cv1 link on","bot1 ourl","Bot1 ourl"]:
                if msg.from_ in admin:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    ki.updateGroup(X)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Cv2 ourl","Cv2 link on","bot2 ourl","Bot2 ourl"]:
                if msg.from_ in admin:
            ...
            elif msg.text in ["Cv2 curl","Cv2 link off","cv2 curl"]:
                if msg.from_ in admin:
                    X = kk.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    kk.updateGroup(X)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        kk.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Cv3 curl","Cv3 link off","cv3 curl"]:
                if msg.from_ in admin:
                    X = kc.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    kc.updateGroup(X)
		...
		kl.sendText(msg.to,Lmid)
                ...
                kc.sendText(msg.to,Cmid)
            elif "Cv4 mid" == msg.text:
                kc.sendText(msg.to,Dmid)
            elif "Cv4 mid" == msg.text:
                kc.sendText(msg.to,Emid)
            elif "Cv4 mid" == msg.text:
                kc.sendText(msg.to,Lmid)
            elif msg.text in ["Wkwk","haha"]:
                msg.contentType = 7
                msg.text = None
                msg.contentMetadata = {
                                     "STKID": "100",
...
#-----------------------------------------------
            ...
            elif msg.text in ["woi masuk","sini masuk","kuy sini","sokin","Sokin","All join"]:
		    if msg.from_ in admin:
			...
			kl.leaveGroup(msg.to)
                ...
                if msg.from_ in admin:
                    ...
                    try:
                        ...
                        pass
            elif msg.text in ["BOT[1] @bye","BOT1 @bye","bot1 @bye","Bot1 @bye","Bot[1] @bye"]:
                if msg.from_ in admin:
                    ginfo = cl.getGroup(msg.to)
                    try:
...
#-----------------------------------------------
                ...
                if msg.from_ in admin:
                    ...
                    for jj in matched_list:
                        try:
                            klist=[ki,kk,kc,kd,ke,kf,kg,kh,kl]
			...
			kl.sendText(msg.to,"Not found Cv")
                        ...
                        for target in targets:
                            try:
                                wait["blacklist"][target] = True
                                f=codecs.open('st2__b.json','w','utf-8')
                                json.dump(wait["blacklist"], f, sort_keys=True, indent=1,ensure_ascii=False)
...
#-----------------------------------------------
		...
		cl.sendText(msg.to,"Ok Boss 􀨁􀄻double thumbs up􏿿")
                ki.sendText(msg.to,"Ok Boss 􀨁􀄻double thumbs up􏿿")
                kk.sendText(msg.to,"Ok Boss 􀨁􀄻double thumbs up􏿿")
                kc.sendText(msg.to,"Ok Boss 􀨁􀄻double thumbs up􏿿")
		kd.sendText(msg.to,"Ok Boss 􀨁􀄻double thumbs up􏿿")
		ke.sendText(msg.to,"Ok Boss 􀨁􀄻double thumbs up􏿿")
		kf.sendText(msg.to,"Ok Boss 􀨁􀄻double thumbs up􏿿")
		kg.sendText(msg.to,"Ok Boss 􀨁􀄻double thumbs up􏿿")
		kh.sendText(msg.to,"Ok Boss 􀨁􀄻double thumbs up􏿿")
		kl.sendText(msg.to,"Ok Boss 􀨁􀄻double thumbs up􏿿")
#-----------------------------------------------
            elif "Bc " in msg.text:
...
#-----------------------------------------------
            ...
            elif msg.text in ["Bot say hai selebdarksquad"]:
                ki.sendText(msg.to,"Hallo member 􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"Hallo member 􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"Hallo member 􀜁􀅔Har Har􏿿")
...
#-----------------------------------------------
            elif msg.text in ["Respon","respon","absen","1-10","absen","Absen"]:
	       if msg.from_ in admin:
