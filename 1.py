...
cl = LINETCR.LINE()
cl.login(token="EkhvRK2idlyPgnMRBMA7.qpULbrRPYbZguXdtBjqiDW.9GQrc5WzfIjRXsZ4MAr7HwrrF+iAQ+JAwFsdNPeQPQ0=")
cl.loginResult()
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.contentType == 13:
              ...
              if msg.from_ in admin:
               ...
               if msg.from_ in admin:
                ...
                cl.sendText(msg.to, +cl.getContact(mid).displayName+" invited you")
            ...
            elif msg.text in ["listgroup","List group"]:
                gid = cl.getGroupIdsJoined()
                h = ""
                for i in gid:
                    h += "=> %s\n" % (cl.getGroup(i).name)
                       ...
                       if targets == []:
                           ...
                           for target in targets:
                                try:
                                    ...
                                    ki.sendText(msg.to,""+contact.displayName+" Sorry Guyss")
