...
cl = LINETCR.LINE()
cl.login(token="EkgHh2O81TXX9WmKmo16.VCXhmd/spgVjHL258mehTG.zBE6VuMtLOojrXarIZvORIv4euhicPIyEHk7tx+RIKY=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EkcFFRzZxQ74I6VyVns4.bxt26xY5LHzztBPJkyb81a.LjUDFzZdLL/hZFOqNHKCAoqVLLfQFDtxZOGW9Jvhl/M=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EkRe4Gt3UggOtX2DycF4.EampqdFzDs4o1XAirM695a.w/P6YthWkpJ1LAGB5D4Fa0Fowsbh/BSQI66Uxo2q4pE=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="Ek2Csij96HgOHA9376Z0.zLmarqoCPzCAnu0YEgdIWa.vXeNK8al9az9eiB8M24NoLJPo2Bmz7GzI+33kIUkHaQ=")
kc.loginResult()

kd = LINETCR.LINE()
kd.login(token="Ek0NB4fOILadMcEmzTH7.h8wq4moe7azCzrO22g+jXW.6vtrrifkSiNugDAcFwMVzsY6zDHqU9WRWEGkm8fdZM0=")
kd.loginResult()

ke = LINETCR.LINE()
ke.login(token="EkuzGR970ZSaRgS4M1H0.Cd3d8niaKPe4bqTU1xTaWa.7yBtLXchz2xyDGNhRFbAGCThY+5HyfXNz+VxFuG1sB8=")
ke.loginResult()

kf = LINETCR.LINE()
kf.login(token="EkY7oAwwAkKE8peXgs2c.HgIPXaGjwsLmlFO+0+Yv3a.4yftnaP3tDRdQvnR23sn1H0doYVGXGS1+iZfPXRp8q0=")
kf.loginResult()

kg = LINETCR.LINE()
kg.login(token="EkAAilE9ktoVxeyS1sF1.tWMyGail59CbvDUARQ0Feq.byy2itPT87DOTKuqBFXt+OI9DG+v2fODu3fu5PP9mog=")
kg.loginResult()

kh = LINETCR.LINE()
kh.login(token="EksXn9jhNxKPBhEYtSFe.Ui6+xW13t47V5fZjQTyYVG.ZP8PU7zo3c7vwux+WLcZRzWnYaQfHCpW7EqvD29mfKM=")
kh.loginResult()

kj = LINETCR.LINE()
kj.login(token="Ekyemn1dAI29yHFUX2Y6.OiBr/bvDBCy31bPdWTyC1G.LvJQYvmxZYyZlfUGOZYEGRGPEDK1V+VTCsJxB30+qNo=")
kj.loginResult()

kl = LINETCR.LINE()
kl.login(token="EkG2d7syAlxAUpIT5ibc.2kdOHb+ADrZFxDVCGyA4Ba.hWq/XWPZk7SuhWXWnRyQMLDTKxGgeuLo9lkE7F4X5Mk=")
kl.loginResult()

km = LINETCR.LINE()
km.login(token="EkRFc38AiIilnj4DqNrb.vRemnuATPLqNM4GSREEygW.NT8PjZQnpQGW6oWCzMpIwvKP+F1IulBThfuBwgFtXQM=")
km.loginResult()

kn = LINETCR.LINE()
kn.login(token="Ek0NUxxCxS0xnVa0Duq3.NM2KQSXh2797espjyzFKGW.4pUmLx8utdfNIqr2bYPuWdO7AZ6iAUNIP9r2mUcN5Lw=")
kn.loginResult()

ko = LINETCR.LINE()
ko.login(token="Ek48MTkGk9aaZIZbskK2.dtONzTkO5MSELlGUCODvWG./N8du5MdNXxEgylMjQNwyK1qpkMxgt9so2fgHbp+pzw=")
ko.loginResult()

kp = LINETCR.LINE()
kp.login(token="EkBPieb3U3ByAVlt0Zia.gBcqUdgLNb+Ns4azmZYBsG./avhSRA8U/nXl7uwAwgspmu5CNg2GScu+MaX6uTAut0=")
kp.loginResult()

kq = LINETCR.LINE()
kq.login(token="EkrJYL2swdaMxZTHlvZf.KZXF7OB5sCJUkq+nJJbBxW.s3OIqOrx0NOGQIvEZwGFTgG1XI7IiWdyNigd0lf0QNA=")
kq.loginResult()

kr = LINETCR.LINE()
kr.login(token="EkEAopIH3X4pUMUYmI24.J2dYioweC8xveO9RShsyra.lfmGTdHXjrjlP02RiIZt0PBpLbrbdUQQ98s9LVDoOrs=")
kr.loginResult()

ks = LINETCR.LINE()
ks.login(token="EkTaw0ROG3bIWMqIf234.C3i/GKrDR1UJjRpozeghTa.5xh5FysxCO8gfBUdaA6WblqaeQSLslktgXcJBl/5jg8=")
ks.loginResult()

kt = LINETCR.LINE()
kt.login(token="EkbaAnGnplIxMLdOxUE0.2pXTrTxyg35OOzNrW8Rkqa.vQRpIeeFbBnmhamqfN4R7J7dHQ5gsOMitHItHu22Mac=")
kt.loginResult()

ku = LINETCR.LINE()
ku.login(token="EkLfNtd2dhxh0CiZ56Qb.ThBrNY05oPcaHPneeWZtEW.d+uEJo5rX/j2bloZv0xc1hVnGBq+N2ztJBuSkaswxJI=")
ku.loginResult()

kv = LINETCR.LINE()
kv.login(token="Ek934enDPpInnjnSBvu5.Zt4YIFAhJQ/aODsJI1I0jq.+X27CC4xfNKCKppZJtNfsemqNbTzX9dJieyoL8Xuv+c=")
kv.loginResult()

kw = LINETCR.LINE()
kw.login(token="Ek53IWnm1Ns4Aob3S3e5.omME3ES84NoVE8UieyG7rq.zbNO/yyCXjv7AUDokKQKBa8O3sNNpKfWBROO7AN+VHE=")
kw.loginResult()

kx = LINETCR.LINE()
kx.login(token="EkU05LkNvO1Sk4EYLDne.YTDwI5QhiUpG18DJ9xbkNG.beHrK8ue4qLt32WkarAIOKUcxNQF4Fev+9jYJWA7i64=")
kx.loginResult()

ky = LINETCR.LINE()
ky.login(token="EkGNXkBrd7lrsYA5Dtt9.Ne9kyLVaJ0ug8J16x9E+/q.Y1qKEq/TVdQdFitRHubfuJMrPNtA9L94GuHjGAhEK+4=")
ky.loginResult()

kz = LINETCR.LINE()
kz.login(token="EkBiL9lWwE8VtxegJt02.yNTgomxYFY48xquXWkx00G.x6TrkJwMNK/DQslHibPF13ONCIrokYBSIZosoFUClJw=")
kz.loginResult()

k1 = LINETCR.LINE()
k1.login(token="EkFy95j0TauwRwnwJhFe.UzbJh+YjXCoFmx4tMD8eNG.ZAho0VwA4r2KOLZIumN3Bd8Eu2lc+Btas4l1b03D3ww=")
k1.loginResult()

k2 = LINETCR.LINE()
k2.login(token="EkUhb1l1jrwFvGZPdUh4.q6BdIyO3JPlewwxC/Aizba.+D+pTOXA8gDwfcuPRGMPZPfGDBNZ9294kYIQ9NHzmeY=")
k2.loginResult()

k3 = LINETCR.LINE()
k3.login(token="EkUStywC11gBes98AZMc.8UgtH4I79UpTZyQs0yuHpa.EGgrYmn+OaFmwxLNNTr+RCsDo/wNejJp9lTHvbGNW8c=")
k3.loginResult()
...
|=>Creator [LOOK CREATOR BOT SAGIRI]
...
*********************************
"""
KAC=[cl,ki,kk,kc,kd,ke,kf,kg,kh,kj,kl,km,kn,ko,kp,kq,kr,ks,kt,ku,kv,kw,kx,ky,kz,k1,k2,k3]
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Jmid,Lmid,Mmid,Nmid,Omid,Pmid,Qmid,Rmid,Smid,Tmid,Umid,Vmid,Wmid,Xmid,Ymid,Zmid,K1mid,K2mid,K3mid,"uaa75cafbc718153f1b0e69998c51f4e7"]
admin=["uaa75cafbc718153f1b0e69998c51f4e7","u3661447738b7d0766102618c427115d8"]
wait = {
    'protect':True,
    'protectinv':True,
    'protectqr':True,
