...
[Kick：「mid」]
[Ginfo]
[Gn 「group name」] (Change Name Group)
[Gift]
[Respon]
...
def bot(op):
	...
	if op.type == 11:
		...
		if wait["protectinv"] == True:
			...
			cl.sendText(msg.to,"Done")
	    elif msg.text in ["protectinv off","Protectinv off","Protectinv:off","protectinv:off"]:
	       if msg.from_ in admin:
		if wait["protectinv"] == False:
			...
			cl.sendText(msg.to,"Done")
	    elif msg.text in ["protectqr on","protectqr:on","Protectqr:on","Protectqr on"]:
	       if msg.from_ in admin:
		...
		if wait["protectqr"] == False:
	       ...
	       if msg.from_ in admin:
                ...
                md = ""
		if waif["protect"] == True: md+=" Protect : on\n"
		else: md+=" protect : off\n"
