...
cl = LINETCR.LINE()
cl.login(token="EmwFLwjy8Bcz0IKQCOlf.FyCqvzVAe2RNaWr3/dbP3W.BVr8rjCItHNVw6VEmVbdGnEP4uCRodj+fWI4JEGPvrQ=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EmqNHfKxReh29ui7XEf1.3QcCJv4kHUj+58p8vc5viq.LUBedhTGoa6f6sutphFCOwlY2vROOiXDiDhPQ1OyyYo=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="Emf365tG8OQfjH9W48S0.0tGK0m6LMWuegE+xHNjzKa.0DSl92IkIX79yY8DzbI7l57+3osJ0PZZ01mRY903bqU=")
kk.loginResult()
	    ...
	    if wait ["protectinv"] == True:
                try:
                    ...
                    try:
                        ...
                        pass
        if op.type == 50:
           cl.sendMessage(op.param1,"通话ing.....")
        if op.type == 51:
           cl.sendMessage(op.param1,"挂断ing.....")
#-----------------------------------------------------
#-----------------------------------------------------
#-----------
        if op.type == 59:
